...
from  torchmeta.modules import MetaConv2d,MetaSequential,MetaBatchNorm2d,MetaModule
from models.convtrans import MetaConvTranspose2d
...
class UNet(MetaModule):
    ...
    def forward(self, x,params=None):
        ...
        return torch.sigmoid(self.conv(dec1,params=get_subdict(params, 'conv')))
